...
export const tools: Tool[] = [
  ...
  { slug: "stopwatch", name: "Online Stopwatch", description: "Stopwatch with lap timer functionality", category: "clock-time", tags: ["stopwatch", "lap", "timer"], status: "coming-soon" },
  { slug: "countdown-timer", name: "Countdown Timer", description: "Set a countdown and share a link", category: "clock-time", tags: ["countdown", "timer", "share"], status: "coming-soon" },
  { slug: "alarm-clock", name: "Alarm Clock", description: "Browser-based alarm clock", category: "clock-time", tags: ["alarm", "clock", "wake"], status: "coming-soon" },
  ...
  // ─── Calendar & Date Tools ──────────────────────────────────
  { slug: "days-until-since", name: "Days Until / Since", description: "Calculate days until or since a date", category: "calendar-date", tags: ["days", "until", "since", "date"], status: "coming-soon" },
  ...
  { slug: "working-days", name: "Working Days Calculator", description: "Calculate working days between dates", category: "calendar-date", tags: ["working", "days", "business"], status: "coming-soon" },
  { slug: "date-add-subtract", name: "Date Add / Subtract", description: "Add or subtract days, months, years from a date", category: "calendar-date", tags: ["date", "add", "subtract", "calculator"], status: "coming-soon" },
  ...
  { slug: "qr-code-generator", name: "QR Code Generator", description: "Generate QR codes for any text or URL", category: "link-url", tags: ["qr", "code", "generator"], status: "coming-soon" },
  ...
  { slug: "url-encode-decode", name: "URL Encoder / Decoder", description: "Encode or decode URL components", category: "link-url", tags: ["url", "encode", "decode"], status: "coming-soon" },
  ...
  { slug: "image-to-base64", name: "Image to Base64", description: "Convert images to Base64 strings", category: "image", tags: ["image", "base64", "encode"], status: "coming-soon" },
  ...
  { slug: "pdf-rotator", name: "PDF Page Rotator", description: "Rotate and reorder PDF pages", category: "pdf", tags: ["pdf", "rotate", "reorder", "page"], status: "coming-soon" },
  { slug: "pdf-form-filler", name: "PDF Form Filler", description: "Fill out PDF forms in the browser", category: "pdf", tags: ["pdf", "form", "fill"], status: "coming-soon" },
  { slug: "pdf-to-image", name: "PDF to Image", description: "Convert PDF pages to PNG or JPG images", category: "pdf", tags: ["pdf", "image", "png", "jpg", "convert"], status: "coming-soon" },
  ...
  { slug: "screen-recorder", name: "Screen Recorder", description: "Record your screen in the browser", category: "video-editing", tags: ["screen", "recorder", "capture"], status: "coming-soon" },
  ...
  // ─── Text & Writing Tools ──────────────────────────────────────
  { slug: "word-counter", name: "Word & Character Counter", description: "Count words, characters, sentences and paragraphs", category: "text-writing", tags: ["word", "character", "counter", "count"], status: "coming-soon" },
  { slug: "case-converter", name: "Case Converter", description: "Convert text between upper, lower, title and other cases", category: "text-writing", tags: ["case", "upper", "lower", "title", "convert"], status: "coming-soon" },
  ...
  { slug: "lorem-ipsum", name: "Lorem Ipsum Generator", description: "Generate placeholder lorem ipsum text", category: "text-writing", tags: ["lorem", "ipsum", "placeholder", "text"], status: "coming-soon" },
  { slug: "duplicate-remover", name: "Duplicate Line Remover", description: "Remove duplicate lines from text", category: "text-writing", tags: ["duplicate", "remove", "line", "unique"], status: "coming-soon" },
  { slug: "text-to-slug", name: "Text to URL Slug", description: "Convert text to URL-friendly slugs", category: "text-writing", tags: ["slug", "url", "text", "convert"], status: "coming-soon" },
  ...
  { slug: "text-sorter", name: "Text Sorter", description: "Sort text lines alphabetically or reverse", category: "text-writing", tags: ["sort", "text", "alphabetical", "reverse"], status: "coming-soon" },
  { slug: "find-replace", name: "Find & Replace", description: "Find and replace text with regex support", category: "text-writing", tags: ["find", "replace", "regex", "text"], status: "coming-soon" },
  ...
  { slug: "whitespace-cleaner", name: "Whitespace Cleaner", description: "Clean up extra whitespace from text", category: "text-writing", tags: ["whitespace", "clean", "space", "trim"], status: "coming-soon" },

  // ─── Developer Tools ──────────────────────────────────────────
  { slug: "json-formatter", name: "JSON Formatter", description: "Format and validate JSON data", category: "developer", tags: ["json", "format", "validate", "pretty"], isMostUsed: true, status: "coming-soon" },
  { slug: "base64-encoder", name: "Base64 Encoder / Decoder", description: "Encode or decode Base64 strings", category: "developer", tags: ["base64", "encode", "decode"], status: "coming-soon" },
  ...
  { slug: "html-entity-encoder", name: "HTML Entity Encoder", description: "Encode and decode HTML entities", category: "developer", tags: ["html", "entity", "encode", "decode"], status: "coming-soon" },
  { slug: "regex-tester", name: "Regex Tester", description: "Test regular expressions with live matching", category: "developer", tags: ["regex", "regular", "expression", "test", "match"], status: "coming-soon" },
  { slug: "markdown-to-html", name: "Markdown to HTML", description: "Convert Markdown to HTML and preview", category: "developer", tags: ["markdown", "html", "convert", "preview"], status: "coming-soon" },
  { slug: "uuid-generator", name: "UUID Generator", description: "Generate unique UUIDs / GUIDs", category: "developer", tags: ["uuid", "guid", "generate", "unique"], status: "coming-soon" },
  { slug: "hash-generator", name: "Hash Generator", description: "Generate MD5, SHA-256 and other hashes", category: "developer", tags: ["hash", "md5", "sha256", "sha", "generate"], status: "coming-soon" },
  { slug: "jwt-decoder", name: "JWT Decoder", description: "Decode and inspect JWT tokens", category: "developer", tags: ["jwt", "token", "decode", "inspect"], status: "coming-soon" },
  ...
  // ─── Data & File Tools ──────────────────────────────────────
  { slug: "csv-to-json", name: "CSV to JSON", description: "Convert CSV and Excel files to JSON", category: "data-file", tags: ["csv", "excel", "json", "convert"], status: "coming-soon" },
  { slug: "json-to-csv", name: "JSON to CSV", description: "Convert JSON data to CSV or Excel", category: "data-file", tags: ["json", "csv", "excel", "convert"], status: "coming-soon" },
  { slug: "file-checksum", name: "File Checksum Verifier", description: "Verify file integrity with checksums", category: "data-file", tags: ["file", "checksum", "hash", "verify", "md5", "sha"], status: "coming-soon" },
  ...
  { slug: "yaml-json-converter", name: "YAML ↔ JSON Converter", description: "Convert between YAML and JSON formats", category: "data-file", tags: ["yaml", "json", "convert"], status: "coming-soon" },

  // ─── Design & Color Tools ──────────────────────────────────
  { slug: "color-palette", name: "Color Palette Generator", description: "Generate harmonious color palettes", category: "design-color", tags: ["color", "palette", "generate", "harmony"], status: "coming-soon" },
  { slug: "gradient-generator", name: "Gradient CSS Generator", description: "Create CSS gradients with a visual editor", category: "design-color", tags: ["gradient", "css", "generator", "color"], status: "coming-soon" },
  { slug: "hex-rgb-hsl", name: "HEX / RGB / HSL Converter", description: "Convert colors between HEX, RGB and HSL", category: "design-color", tags: ["hex", "rgb", "hsl", "color", "convert"], status: "coming-soon" },
  { slug: "contrast-checker", name: "Contrast Ratio Checker", description: "Check WCAG contrast ratios for accessibility", category: "design-color", tags: ["contrast", "wcag", "accessibility", "ratio"], status: "coming-soon" },
  { slug: "favicon-generator", name: "Favicon Generator", description: "Generate favicons from images or text", category: "design-color", tags: ["favicon", "icon", "generator"], status: "coming-soon" },
  { slug: "border-radius-generator", name: "Border Radius Generator", description: "Generate CSS border radius visually", category: "design-color", tags: ["border", "radius", "css", "generator"], status: "coming-soon" },
  ...
  { slug: "password-generator", name: "Password Generator", description: "Generate strong, secure passwords", category: "security-privacy", tags: ["password", "generate", "secure", "strong"], isMostUsed: true, status: "coming-soon" },
  { slug: "password-strength", name: "Password Strength Checker", description: "Check how strong your password is", category: "security-privacy", tags: ["password", "strength", "check", "security"], status: "coming-soon" },
  { slug: "text-encryptor", name: "Text Encryptor", description: "Encrypt and decrypt text with AES", category: "security-privacy", tags: ["encrypt", "decrypt", "text", "aes", "security"], status: "coming-soon" },
  ...
  { slug: "fake-data-generator", name: "Fake Data Generator", description: "Generate fake identity and data for testing", category: "security-privacy", tags: ["fake", "data", "identity", "generator", "test"], status: "coming-soon" },
  ...
  { slug: "dns-lookup", name: "DNS Lookup", description: "Look up DNS records for any domain", category: "network-web", tags: ["dns", "lookup", "domain", "record"], status: "coming-soon" },
  ...
  { slug: "my-ip", name: "My IP Address", description: "Find your public IP address", category: "network-web", tags: ["ip", "address", "my", "public"], status: "coming-soon" },
  ...
  { slug: "number-base-converter", name: "Number Base Converter", description: "Convert between binary, hex, octal and decimal", category: "converters-calculators", tags: ["binary", "hex", "octal", "decimal", "convert"], status: "coming-soon" },
  { slug: "age-calculator", name: "Age Calculator", description: "Calculate your exact age in years, months, days", category: "converters-calculators", tags: ["age", "calculator", "birthday"], status: "coming-soon" },
  { slug: "date-difference", name: "Date Difference Calculator", description: "Calculate the difference between two dates", category: "converters-calculators", tags: ["date", "difference", "between", "days"], status: "coming-soon" },
  ...
  { slug: "roman-numeral", name: "Roman Numeral Converter", description: "Convert between Roman and Arabic numerals", category: "converters-calculators", tags: ["roman", "numeral", "convert"], status: "coming-soon" },
  { slug: "fraction-simplifier", name: "Fraction Simplifier", description: "Simplify fractions to their lowest terms", category: "converters-calculators", tags: ["fraction", "simplify", "math"], status: "coming-soon" },
  { slug: "percentage-calculator", name: "Percentage Calculator", description: "Calculate percentages quickly", category: "converters-calculators", tags: ["percentage", "calculator", "math"], status: "coming-soon" },
  ...
  // ─── Finance & Business ──────────────────────────────────────
  { slug: "gst-calculator", name: "GST / VAT Calculator", description: "Calculate GST or VAT for any amount", category: "finance-business", tags: ["gst", "vat", "tax", "calculator"], status: "coming-soon" },
  { slug: "emi-calculator", name: "EMI / Loan Calculator", description: "Calculate EMI for loans and mortgages", category: "finance-business", tags: ["emi", "loan", "mortgage", "calculator"], status: "coming-soon" },
  ...
  { slug: "tip-calculator", name: "Tip Calculator", description: "Calculate tips and split bills", category: "finance-business", tags: ["tip", "calculator", "bill", "split"], status: "coming-soon" },
  { slug: "discount-calculator", name: "Discount Calculator", description: "Calculate discounts and profit margins", category: "finance-business", tags: ["discount", "profit", "margin", "calculator"], status: "coming-soon" },
  { slug: "sip-calculator", name: "SIP Calculator", description: "Calculate SIP and mutual fund returns", category: "finance-business", tags: ["sip", "mutual", "fund", "returns", "investment"], status: "coming-soon" },
  { slug: "fd-calculator", name: "FD / RD Calculator", description: "Calculate fixed and recurring deposit interest", category: "finance-business", tags: ["fd", "rd", "interest", "deposit", "calculator"], status: "coming-soon" },
  { slug: "salary-calculator", name: "Salary Calculator", description: "Calculate take-home pay after deductions", category: "finance-business", tags: ["salary", "take-home", "pay", "calculator"], status: "coming-soon" },
  ...
  // ─── SEO & Web Tools ──────────────────────────────────────
  { slug: "meta-tag-generator", name: "Meta Tag Generator", description: "Generate SEO-friendly meta tags", category: "seo-web", tags: ["meta", "tag", "seo", "generator"], status: "coming-soon" },
  { slug: "robots-txt-generator", name: "Robots.txt Generator", description: "Generate robots.txt files for your website", category: "seo-web", tags: ["robots", "txt", "seo", "crawler"], status: "coming-soon" },
  { slug: "sitemap-generator", name: "Sitemap Generator", description: "Generate XML sitemaps for your website", category: "seo-web", tags: ["sitemap", "xml", "seo", "generator"], status: "coming-soon" },
  { slug: "domain-age-checker", name: "Domain Age Checker", description: "Check the age of any domain", category: "seo-web", tags: ["domain", "age", "check"], status: "coming-soon" },
  { slug: "website-screenshot", name: "Website Screenshot", description: "Take screenshots of any website", category: "seo-web", tags: ["website", "screenshot", "capture"], status: "coming-soon" },
  { slug: "keyword-density", name: "Keyword Density Checker", description: "Check keyword density of your content", category: "seo-web", tags: ["keyword", "density", "seo", "content"], status: "coming-soon" },
  ...
  // ─── Social Media Tools ──────────────────────────────────────
  { slug: "hashtag-generator", name: "Hashtag Generator", description: "Generate relevant hashtags for your posts", category: "social-media", tags: ["hashtag", "social", "media", "generate"], status: "coming-soon" },
  ...
  { slug: "twitter-counter", name: "Twitter Character Counter", description: "Count characters for Twitter/X posts", category: "social-media", tags: ["twitter", "character", "counter", "x"], status: "coming-soon" },
  { slug: "instagram-formatter", name: "Instagram Caption Formatter", description: "Format Instagram captions with line breaks", category: "social-media", tags: ["instagram", "caption", "format", "line break"], status: "coming-soon" },
  ...
  { slug: "youtube-tester", name: "YouTube Title Tester", description: "Test YouTube titles and thumbnails", category: "social-media", tags: ["youtube", "title", "thumbnail", "test"], status: "coming-soon" },
  { slug: "emoji-picker", name: "Emoji Picker", description: "Pick and combine emojis easily", category: "social-media", tags: ["emoji", "picker", "combine"], status: "coming-soon" },
  ...
  { slug: "gpa-calculator", name: "GPA Calculator", description: "Calculate your grade point average", category: "student-education", tags: ["gpa", "grade", "calculator", "academic"], status: "coming-soon" },
  { slug: "pomodoro-timer", name: "Pomodoro Timer", description: "Study timer with pomodoro technique and stats", category: "student-education", tags: ["pomodoro", "timer", "study", "focus"], status: "coming-soon" },
  ...
  // ─── Health & Fitness ──────────────────────────────────────
  { slug: "bmi-ideal-weight", name: "BMI & Ideal Weight", description: "Calculate BMI and ideal weight range", category: "health-fitness", tags: ["bmi", "ideal", "weight", "health"], status: "coming-soon" },
  { slug: "body-fat", name: "Body Fat Estimator", description: "Estimate your body fat percentage", category: "health-fitness", tags: ["body", "fat", "percentage", "estimate"], status: "coming-soon" },
  { slug: "one-rep-max", name: "One Rep Max Calculator", description: "Calculate your one rep max for weightlifting", category: "health-fitness", tags: ["one rep max", "1rm", "weightlifting", "strength"], status: "coming-soon" },
  { slug: "running-pace", name: "Running Pace Calculator", description: "Calculate running pace and speed", category: "health-fitness", tags: ["running", "pace", "speed", "calculator"], status: "coming-soon" },
  ...
  { slug: "water-intake", name: "Water Intake Calculator", description: "Calculate daily water intake recommendations", category: "health-fitness", tags: ["water", "intake", "hydration", "calculator"], status: "coming-soon" },
  ...
  // ─── Travel & Commute ──────────────────────────────────────
  { slug: "fuel-calculator", name: "Fuel Cost Calculator", description: "Calculate fuel costs for your trip", category: "travel-commute", tags: ["fuel", "cost", "trip", "calculator"], status: "coming-soon" },
  { slug: "speed-distance-time", name: "Speed / Distance / Time", description: "Calculate speed, distance, or time", category: "travel-commute", tags: ["speed", "distance", "time", "calculator"], status: "coming-soon" },
  ...
  // ─── Food & Cooking ──────────────────────────────────────
  { slug: "recipe-converter", name: "Recipe Unit Converter", description: "Convert recipe units (cups, grams, etc.)", category: "food-cooking", tags: ["recipe", "unit", "converter", "cooking"], status: "coming-soon" },
  { slug: "cooking-timer", name: "Multiple Cooking Timer", description: "Set multiple timers for cooking", category: "food-cooking", tags: ["cooking", "timer", "multiple", "kitchen"], status: "coming-soon" },
  ...
  { slug: "sale-calculator", name: "Sale Price Calculator", description: "Calculate discount and sale prices", category: "shopping-deals", tags: ["sale", "price", "discount", "calculator"], status: "coming-soon" },
  ...
  { slug: "barcode-generator", name: "Barcode Generator", description: "Generate barcodes for products", category: "ecommerce-seller", tags: ["barcode", "generator", "product"], status: "coming-soon" },
  ...
  { slug: "random-picker", name: "Random Picker / Wheel", description: "Spin a wheel or pick randomly", category: "fun-viral", tags: ["random", "picker", "wheel", "spinner"], status: "coming-soon" },
  ...
  { slug: "truth-or-dare", name: "Truth or Dare", description: "Generate truth or dare questions", category: "fun-viral", tags: ["truth", "dare", "game", "fun"], status: "coming-soon" },
  ...
  { slug: "morse-code", name: "Morse Code Converter", description: "Encode and decode Morse code", category: "language-translation", tags: ["morse", "code", "encode", "decode"], status: "coming-soon" },
  { slug: "braille-converter", name: "Braille Converter", description: "Convert text to Braille", category: "language-translation", tags: ["braille", "convert", "accessibility"], status: "coming-soon" },
  ...
  { slug: "text-to-speech", name: "Text to Speech", description: "Convert text to speech online", category: "language-translation", tags: ["tts", "text", "speech", "audio"], status: "coming-soon" },
  ...
  { slug: "online-notepad", name: "Online Notepad", description: "Simple online notepad and scratchpad", category: "general-productivity", tags: ["notepad", "notes", "scratchpad", "text"], status: "coming-soon" },
