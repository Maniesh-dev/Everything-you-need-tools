...
import { getMostUsedTools } from "@/lib/tools-registry";
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h2 className="flex items-center gap-2 font-heading text-2xl font-bold sm:text-3xl">
            <Star weight="fill" className="text-yellow-500" /> Most Used Tools
          </h2>
          <p className="mt-1 text-sm text-muted-foreground">
            Our users' constant favorites
          </p>
        </div>
      </div>
